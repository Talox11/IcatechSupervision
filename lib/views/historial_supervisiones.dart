...
class HistorialSupervisiones extends StatefulWidget {
  const HistorialSupervisiones({Key? key}) : super(key: key);

  @override
  State<HistorialSupervisiones> createState() => _HistorialSupervisionesState();
}

class _HistorialSupervisionesState extends State<HistorialSupervisiones> {
  ...
  @override
  void initState() {
    _listGrupos = HttpHandle().historialCursosSupervisados();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: 'Historial de Supervisiones',
      ...
      body: ListView(
        ...
        children: [
          FutureBuilder(
              future: HttpHandle().historialCursosSupervisados(),
